...
# --- from flask_sqlalchemy module import SQLAlchemy class to create database ---
from flask_sqlalchemy import SQLAlchemy
from datetime import datetime

app = Flask("app")

# --- configure database root location ---
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///villain.db"

# --- create new database object ---
# --- set equal to class imported to give access to class ---
# --- pass app as argument ---
db = SQLAlchemy(app)

# --- organize database columns ---
